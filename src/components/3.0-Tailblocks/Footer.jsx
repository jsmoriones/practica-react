const Footer = () => {
    const styleLinkFooter = "text-gray-600 hover:text-gray-800"
  return (
    <footer className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <li>
                    <a className={styleLinkFooter}>First Link</a>
                </li>
                <li>
                    <a className={styleLinkFooter}>Second Link</a>
                </li>
                <li>
                    <a className={styleLinkFooter}>Third Link</a>
                </li>
                <li>
                    <a className={styleLinkFooter}>Fourth Link</a>
                </li>
                </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
